       ...
       <!-- User Account: style can be found in dropdown.less -->
              ...
              <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="<?php echo site_url()?>/pengarang/"><i class="fa fa-circle-o"></i> Pengarang Buku</a></li>
        ...
        <!-- Isi -->
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <a href="<?php echo site_url()?>/pengarang/create"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Pengarang</button></a>
            <br><br>
                    ...
                    <tbody>
                        <?php foreach ($pengarang_list as $key) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url('pengarang/update/').$key->id ?>" type="button" class="btn btn-success"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</a>
                                    <a href="<?php echo site_url('pengarang/delete/').$key->id ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
