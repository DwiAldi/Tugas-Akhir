       ...
       <!-- User Account: style can be found in dropdown.less -->
              ...
              <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="<?php echo site_url()?>/Kategori_Admin/"><i class="fa fa-circle-o"></i> Kategori Buku</a></li>
        ...
        <!-- Isi -->
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <a href="<?php echo site_url()?>/kategori/create"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Kategori</button></a>
            <br><br>
            <?php if ($this->session->flashdata('fail')) {
                ...
                <?php
                    ...
                    <strong><?php echo $this->session->flashdata('terhapus');?></strong></div><?php>
                <?php } ?>

            <!-- <?php echo $this->session->flashdata('fail'); ?>
            <?php echo $this->session->flashdata('terhapus'); ?> -->
                    ...
                    <tbody>
                        <?php foreach ($kategori as $key) { ?>
                            <tr>
                                ...
                                <td><?php echo $key->deskripsiKategori ?></td>
                                <td>
                                    <a href="<?php echo site_url('kategori_admin/update/').$key->id ?>" type="button" class="btn btn-success"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</a>
                                    <a href="<?php echo site_url('kategori_admin/delete/').$key->id ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
