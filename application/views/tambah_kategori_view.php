		  ...
		  <div class="content-wrapper">
			...
			<div class="row">
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
					<?php echo form_open_multipart('kategori_admin/create'); ?>
					<form action="" method="POST" role="form">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Masukan Deskripsi Kategori">
						</div>
