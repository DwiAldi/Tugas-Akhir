...
<html lang="">
	...
	<body class="hold-transition skin-blue sidebar-mini">
		    ...
		    <section class="sidebar">
		      ...
		      <ul class="sidebar-menu">
		        ...
		        <li class="treeview">
		          ...
		          <ul class="treeview-menu">
		            <li><a href="<?php echo site_url()?>/transaksi/"><i class="fa fa-circle-o"></i>Peminjaman Buku</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<?php echo form_open_multipart('home_admin/update/'.$this->uri->segment(3)); ?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="username" name="username" placeholder="Edit Username" value="<?php echo $user[0]->username ?>">
									<br>
									<label for="">Password</label>
									<input type="text" class="form-control" id="password" name="password" placeholder="Edit Password" value="">
									<br>
									<label for="">Konfirmasi</label>
									<input type="text" class="form-control" id="konfirmasi_password" name="konfirmasi_password" placeholder="Edit Konfirmasi Password" value="">
									<br>
									<label for="">Nama</label>
									<input type="text" class="form-control" id="nama" name="nama" placeholder="Edit Nama" value="<?php echo $user[0]->nama ?>">
									<br>
									<label for="">Nim</label>
									<input type="text" class="form-control" id="nim" name="nim" placeholder="Edit NIM" value="<?php echo $user[0]->nim ?>">
									<br>
									<label for="">Alamat</label>
									<input type="text" class="form-control" id="alamat" name="alamat" placeholder="Edit Alamat" value="<?php echo $user[0]->alamat ?>">
									<br>
									<label for="">No. Telepon</label>
									<input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Edit Nomor Telepon" value="<?php echo $user[0]->no_telp ?>">
									<br>
									<label for="">Tanggal Lahir</label>
									<input type="text" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="Edit Tanggal Lahir" value="<?php echo $user[0]->tgl_lahir ?>">
								</div>
								<div class="form-group">
								...
								<a href="<?php echo site_url('Home_Admin/')?>" type="button" class="btn btn-primary">Back</a>
					<?php echo form_close(); ?>
