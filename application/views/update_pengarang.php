...
<html lang="">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<?php echo form_open_multipart('pengarang/update/'.$this->uri->segment(3)); ?>
						<legend>Edit Data Pengarang</legend>
						<!--<pre><?php 
						var_dump($pegawai); 
						?>-->
						</pre>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama" name="nama" placeholder="" value="<?php echo $pengarang[0]->namaPengarang?>">
						</div>
						<button type="submit" class="btn btn-success">Submit</button>
						<a href="<?php echo site_url('pengarang/')?>" type="button" class="btn btn-primary">Back</a>
			<?php echo form_close(); ?>
		</div>
        </div>
         </section>
