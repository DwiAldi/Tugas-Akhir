    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <?php echo form_open_multipart('buku_admin/create'); ?>
                    <form action="" method="POST" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="judulBuku" name="judulBuku" placeholder="Masukan Judul Buku">
                        </div>
                        <div class="form-group">
                                    ...
                                    if (count) {
                                       if (count($kategori)) {
                                            foreach ($kategori as $list) {
                                                echo "<option value='". $list['id'] . "'>" . $list['namaKategori'] . "</option>";
                                            }
                                        }
                                    }
                                 ?>
                                    ...
                                    if (count) {
                                        if (count($pengarang)) {
                                            foreach ($pengarang as $list) {
                                                echo "<option value='".$list['id']."'>".$list['namaPengarang']."</option>";
                                            }
                                        }
                                    }
                                 ?>
                                    ...
                                    if (count) {
                                       if (count($penerbit)) {
                                            foreach ($penerbit as $list) {
                                                echo "<option value='". $list['id'] . "'>" . $list['namaPenerbit'] . "</option>";
                                            }
                                        }
                                    }
                                 ?>
                        ...
                        <a href="<?php echo site_url('Buku_Admin/')?>" type="button" class="btn btn-primary">Back</a>
                    </form>
                    <?php echo form_close(); ?>
                </div>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
              $("#kategori,#pengarang,#penerbit").select2();
            });
        </script>
        <!-- Admin-LTE -->
        <!-- jQuery 2.2.3 -->
