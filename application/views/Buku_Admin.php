       ...
       <!-- User Account: style can be found in dropdown.less -->
              ...
              <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                    <li class="active"><a href="<?php echo site_url()?>/Buku_Admin/"><i class="fa fa-circle-o"></i> Daftar Buku</a></li>
        ...
        <!-- Isi -->
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <a href="<?php echo site_url()?>/buku_admin/create"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Buku</button></a>
            <br><br>
                    ...
                    <tbody>
                        <?php foreach ($buku_list as $key) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url('penerbit/update/').$key->idBuku ?>" type="button" class="btn btn-success"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</a>
                                    <a href="<?php echo site_url('buku_admin/delete/').$key->idBuku ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
