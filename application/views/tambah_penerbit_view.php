				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
					...
					<form action="" method="POST" role="form">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Penerbit">
						</div>
						<div class="form-group">
							<label for="">Alamat Penerbit</label>
							<input type="text" class="form-control" id="alamat" name="alamat" placeholder="Masukan Alamat Penerbit">
						</div>
						<div class="form-group">
							<label for="">Nomor Telepon</label>
							<input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Masukan Nomor Telepon Penerbit">
						</div>
