...
<html lang="">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
              ...
              <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="<?php echo site_url()?>/penerbit/"><i class="fa fa-circle-o"></i> Penerbit Buku</a></li>
                  </ul>
                </li>
                <li class="treeview">
                  <a href="#">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<?php echo form_open_multipart('penerbit/update/'.$this->uri->segment(3)); ?>
						<legend>Edit Data Penerbit</legend>
						<!--<pre><?php 
						var_dump($pegawai); 
						?>-->
						</pre>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="namaPenerbit" name="namaPenerbit" placeholder="" value="<?php echo $penerbit[0]->namaPenerbit ?>">
							<br>
							<label for="">Alamat Penerbit</label>
							<input type="text" class="form-control" id="alamatPenerbit" name="alamatPenerbit" placeholder="" value="<?php echo $penerbit[0]->alamatPenerbit ?>">
							<br>
							<label for="">Nomor Telepon</label>
							<input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="" value="<?php echo $penerbit[0]->no_telp ?>">
							<br>
						</div>
						<button type="submit" class="btn btn-success">Submit</button>
						<a href="<?php echo site_url('penerbit/')?>" type="button" class="btn btn-primary">Back</a>
			<?php echo form_close(); ?>
		</div>
        </div>
         </section>
