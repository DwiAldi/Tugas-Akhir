...
<html lang="">
	...
	<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<?php echo form_open_multipart('kategori_admin/update/'.$this->uri->segment(3)); ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama" name="nama" placeholder="" value="<?php echo $kategori[0]->namaKategori ?>">
							<br>
							<label for="">Deskripsi Kategori</label>
							<input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="" value="<?php echo $kategori[0]->deskripsiKategori ?>">
						</div>
						<button type="submit" class="btn btn-success">Submit</button>
						<a href="<?php echo site_url('kategori_admin/')?>" type="button" class="btn btn-primary">Back</a>
			<?php echo form_close(); ?>
		</div>
        </div>
		 </section>
